 ...
 * 
 * Time Complexity: O(N) where N is total characters in sentence
 * Space Complexity: O(M) where M is total characters in dictionary
 */

function replaceWords(dictionary, sentence) {
    // TODO: Implement replace words using trie
}
